  ...
  return (
    <div>
      <div className="flex content-center align-middle">
        <Image src={'/mainpage/recipeFirstParagraph.jpg'} width={200} height={200} alt="recipe" className="float-left mr-2" priority={true}  />
      ...
      <div className="mt-8">
        <Image src={'/mainpage/recipeSecondParagraph.jpg'} width={200} height={200} alt="recipe" className="float-right mr-2"  priority={true}/>
      ...
      <div className="mt-8 flex content-center align-middle">
        <Image src={'/mainpage/recipeThirdParagraph.jpg'} width={200} height={200} alt="recipe" className="float-left mr-2" priority={true} />
        <div>
          ...
          <Link className="mt-8 float-right" href={AppData.getUrlByType(NavPageType.TrendRecipe)}>
