...
import NavPage from '@/types/infrastructure/NavPage'
import AppData from '@/infrastructure/AppData'
import { DropdownMenu, DropdownMenuContent, DropdownMenuGroup, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger } from '@radix-ui/react-dropdown-menu'
import {
    Avatar,
    AvatarFallback,
    AvatarImage,
...
export default function Navbar() {
    ...
    const [pages, setPages] = useState<NavPage[]>(AppData.getNavPages)

    const path = usePathname();
    const router = useRouter();
    const [openLang, setOpenLan] = useState(false);
            ...
            <div className="flex w-full flex-wrap items-center justify-between px-3">
                ...
                >
                    <div onClick={logoClick}
                        className="hover:cursor-pointer mb-4 ml-2 mr-5 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mb-0 lg:mt-0"
                    >
                        <img
                            src="/LogoChef.ico"
                            style={{ height: '30px' }}
                ...
                <div className=" flex items-center">
                    <div
                        ...
                        <div className='relative mr-6'>
                            <button id="states-button" onClick={() => setOpenLan(!openLang)} className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">
                            ...
                            <div id="dropdown-states" className={`z-10 ${openLang && 'hidden'} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute top-15 right-1`}>
