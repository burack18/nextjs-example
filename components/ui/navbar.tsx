...
export default function Navbar() {
    ...
    const [openLang, setOpenLan] = useState(true);
                ...
                <div className=" flex items-center">
                    <div
                        ...
                        <div className='relative mr-6'>
                            <button id="states-button" onClick={() => setOpenLan(!openLang)} className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500  hover:underline focus:outline-none focus:border-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">
